...
-- Date        : Wed Mar 10 21:53:28 2021
-- Host        : DESKTOP-4HQCNQE running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               g:/Vivado/Pynq_file/PYNQ-master/boards/Pynq-Z2/base/Test_dma/Test_dma.srcs/sources_1/bd/base/ip/base_AXI_aud_interface_0_upgraded_ipi_0/base_AXI_aud_interface_0_upgraded_ipi_0_sim_netlist.vhdl
...
entity base_AXI_aud_interface_0_upgraded_ipi_0_AXI_aud_interface is
  port (
  ...
  attribute ORIG_REF_NAME of base_AXI_aud_interface_0_upgraded_ipi_0_AXI_aud_interface : entity is "AXI_aud_interface";
end base_AXI_aud_interface_0_upgraded_ipi_0_AXI_aud_interface;

architecture STRUCTURE of base_AXI_aud_interface_0_upgraded_ipi_0_AXI_aud_interface is
  signal \FSM_onehot_state_Curr[0]_i_1_n_0\ : STD_LOGIC;
  signal \FSM_onehot_state_Curr[0]_i_2_n_0\ : STD_LOGIC;
  signal \FSM_onehot_state_Curr[1]_i_1_n_0\ : STD_LOGIC;
  signal \FSM_onehot_state_Curr[2]_i_1_n_0\ : STD_LOGIC;
  signal \FSM_onehot_state_Curr[2]_i_2_n_0\ : STD_LOGIC;
  ...
  signal s_axis_aud_tready_i_3_n_0 : STD_LOGIC;
  signal \^s_axis_aud_tready_reg_0\ : STD_LOGIC;
  signal state_Curr : STD_LOGIC_VECTOR ( 0 to 0 );
  signal state_Curr_reg : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \state_Next1__0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_state_Curr[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_onehot_state_Curr[0]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_onehot_state_Curr[2]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_onehot_state_Curr[2]_i_3\ : label is "soft_lutpair1";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_Curr_reg[0]\ : label is "wait_for_data:001,get_data_r:100,get_data_l:010";
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_Curr_reg[1]\ : label is "wait_for_data:001,get_data_r:100,get_data_l:010";
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_Curr_reg[2]\ : label is "wait_for_data:001,get_data_r:100,get_data_l:010";
begin
...
\FSM_onehot_state_Curr[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFFEEEE"
    )
        port map (
...
\FSM_onehot_state_Curr[2]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\FSM_onehot_state_Curr[2]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\L_Data[23]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
...
L_Data_valid_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"A0FF2000"
    )
        port map (
...
\R_Data[23]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
R_Data_valid_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"C0FF4000"
    )
        port map (
...
s_axis_aud_tready_i_2: unisim.vcomponents.LUT6
    generic map(
...
s_axis_aud_tready_i_3: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_AXI_aud_interface_0_upgraded_ipi_0 is
  port (
    s_axis_aud_aclk : in STD_LOGIC;
    s_axis_aud_aresetn : in STD_LOGIC;
    s_axis_aud_tdata : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute NotValidForBitStream of base_AXI_aud_interface_0_upgraded_ipi_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of base_AXI_aud_interface_0_upgraded_ipi_0 : entity is "base_AXI_aud_interface_0_upgraded_ipi_0,AXI_aud_interface,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of base_AXI_aud_interface_0_upgraded_ipi_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of base_AXI_aud_interface_0_upgraded_ipi_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of base_AXI_aud_interface_0_upgraded_ipi_0 : entity is "AXI_aud_interface,Vivado 2020.2";
end base_AXI_aud_interface_0_upgraded_ipi_0;

architecture STRUCTURE of base_AXI_aud_interface_0_upgraded_ipi_0 is
...
begin
inst: entity work.base_AXI_aud_interface_0_upgraded_ipi_0_AXI_aud_interface
     port map (
