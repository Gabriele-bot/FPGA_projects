...
HD_PWD='G:/Vivado/FFT_VIDEO/FFT_VIDEO_2048/FFT_VIDEO_2048.runs/base_FFT_L_last_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_FFT_L_last_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_FFT_L_last_2.tcl
