...
HD_PWD='G:/Vivado/FFT_VIDEO/FFT_VIDEO_2048.xpr/FFT_VIDEO_2048/FFT_VIDEO_2048.runs/base_Pulse_LED_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_Pulse_LED_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_Pulse_LED_controller_0_0.tcl
