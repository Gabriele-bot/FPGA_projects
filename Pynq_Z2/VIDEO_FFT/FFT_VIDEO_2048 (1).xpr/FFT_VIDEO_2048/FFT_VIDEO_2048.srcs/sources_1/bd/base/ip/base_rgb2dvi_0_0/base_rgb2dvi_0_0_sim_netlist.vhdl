...
--               d:/Progetti_vivado/FFT_VIDEO/FFT_VIDEO.srcs/sources_1/bd/base/ip/base_rgb2dvi_0_0/base_rgb2dvi_0_0_sim_netlist.vhdl
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_rgb2dvi_0_0_SyncAsync_6 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_rgb2dvi_0_0_SyncAsync_6 : entity is "SyncAsync";
end base_rgb2dvi_0_0_SyncAsync_6;

architecture STRUCTURE of base_rgb2dvi_0_0_SyncAsync_6 is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \base_rgb2dvi_0_0_SyncAsync__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \base_rgb2dvi_0_0_SyncAsync__parameterized1\ : entity is "SyncAsync";
end \base_rgb2dvi_0_0_SyncAsync__parameterized1\;

architecture STRUCTURE of \base_rgb2dvi_0_0_SyncAsync__parameterized1\ is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_rgb2dvi_0_0_ResetBridge_5 is
  port (
    AS : out STD_LOGIC_VECTOR ( 0 to 0 );
    aRst_n : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_rgb2dvi_0_0_ResetBridge_5 : entity is "ResetBridge";
end base_rgb2dvi_0_0_ResetBridge_5;

architecture STRUCTURE of base_rgb2dvi_0_0_ResetBridge_5 is
  signal aRst_int_0 : STD_LOGIC;
  attribute RTL_KEEP : string;
  attribute RTL_KEEP of aRst_int_0 : signal is "true";
begin
SyncAsyncx: entity work.base_rgb2dvi_0_0_SyncAsync_6
     port map (
      AS(0) => AS(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_rgb2dvi_0_0_ClockGen is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_rgb2dvi_0_0_ClockGen : entity is "ClockGen";
end base_rgb2dvi_0_0_ClockGen;

architecture STRUCTURE of base_rgb2dvi_0_0_ClockGen is
...
LockLostReset: entity work.base_rgb2dvi_0_0_ResetBridge_5
     port map (
      AS(0) => pRst,
      aRst_n => aRst_n,
      \oSyncStages_reg[0]\ => \oSyncStages_reg[0]\
    );
PLL_LockSyncAsync: entity work.\base_rgb2dvi_0_0_SyncAsync__parameterized1\
     port map (
      D(0) => oOut,
      \oSyncStages_reg[0]_0\ => \oSyncStages_reg[0]\,
...
entity base_rgb2dvi_0_0_rgb2dvi is
  ...
  attribute kGenerateSerialClk of base_rgb2dvi_0_0_rgb2dvi : entity is "TRUE";
...
begin
\ClockGenInternal.ClockGenX\: entity work.base_rgb2dvi_0_0_ClockGen
     port map (
      PixelClk => PixelClkIO,
