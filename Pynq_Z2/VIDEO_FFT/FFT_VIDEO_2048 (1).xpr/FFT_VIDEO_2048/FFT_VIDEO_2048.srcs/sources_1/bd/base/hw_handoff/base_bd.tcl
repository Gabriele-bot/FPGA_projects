...
proc create_hier_cell_HDMI_FFT_LR { parentCell nameHier } {
  ...
  # Create instance: BRAM_DIN_SLICE1, and set properties
  set BRAM_DIN_SLICE1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 BRAM_DIN_SLICE1 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {15} \
   CONFIG.DIN_WIDTH {32} \
  ...
  # Create instance: BRAM_WE_SLICE2, and set properties
  set BRAM_WE_SLICE2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 BRAM_WE_SLICE2 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_WIDTH {4} \
   CONFIG.DOUT_WIDTH {2} \
  ...
  # Create instance: CORDIC_FIFO_L, and set properties
  set CORDIC_FIFO_L [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 CORDIC_FIFO_L ]
  set_property -dict [ list \
  ...
  # Create instance: CORDIC_FIFO_R, and set properties
  set CORDIC_FIFO_R [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 CORDIC_FIFO_R ]
  set_property -dict [ list \
   CONFIG.FIFO_DEPTH {64} \
   CONFIG.HAS_TLAST {1} \
   CONFIG.TDATA_NUM_BYTES {4} \
  ...
  # Create instance: FFT_L_data, and set properties
  set FFT_L_data [ create_bd_cell -type ip -vlnv xilinx.com:user:mux_vector:1.0 FFT_L_data ]
  set_property -dict [ list \
   CONFIG.C_SIZE {48} \
   CONFIG.DELAY {0} \
 ] $FFT_L_data

  # Create instance: FFT_L_last, and set properties
  set FFT_L_last [ create_bd_cell -type ip -vlnv xilinx.com:user:mux_vector:1.0 FFT_L_last ]
  set_property -dict [ list \
   CONFIG.C_SIZE {1} \
   CONFIG.DELAY {0} \
 ] $FFT_L_last

  # Create instance: FFT_L_valid, and set properties
  set FFT_L_valid [ create_bd_cell -type ip -vlnv xilinx.com:user:mux_vector:1.0 FFT_L_valid ]
  set_property -dict [ list \
   CONFIG.C_SIZE {1} \
   CONFIG.DELAY {0} \
 ] $FFT_L_valid
  ...
  # Create instance: FFT_R_data, and set properties
  set FFT_R_data [ create_bd_cell -type ip -vlnv xilinx.com:user:mux_vector:1.0 FFT_R_data ]
  set_property -dict [ list \
   CONFIG.C_SIZE {48} \
   CONFIG.DELAY {0} \
 ] $FFT_R_data

  # Create instance: FFT_R_last, and set properties
  set FFT_R_last [ create_bd_cell -type ip -vlnv xilinx.com:user:mux_vector:1.0 FFT_R_last ]
  set_property -dict [ list \
   CONFIG.C_SIZE {1} \
   CONFIG.DELAY {0} \
 ] $FFT_R_last

  # Create instance: FFT_R_valid, and set properties
  set FFT_R_valid [ create_bd_cell -type ip -vlnv xilinx.com:user:mux_vector:1.0 FFT_R_valid ]
  set_property -dict [ list \
   CONFIG.C_SIZE {1} \
   CONFIG.DELAY {0} \
 ] $FFT_R_valid

  # Create instance: FFT_WINDOW_en, and set properties
  set FFT_WINDOW_en [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 FFT_WINDOW_en ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
  ...
  if { [catch {set Packet_framer_L [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.AXIS_DATA_WIDTH_OUT {48} \
   CONFIG.PACKET_N_DATA {2048} \
 ] $Packet_framer_L
  ...
  # Create instance: Windowing_L, and set properties
  set block_name Windowing
  set block_cell_name Windowing_L
  if { [catch {set Windowing_L [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Windowing_L eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.PACKET_LEGHT {0x0800} \
   CONFIG.PACKET_LENGHT_WIDTH {11} \
 ] $Windowing_L

  # Create instance: Windowing_R, and set properties
  set block_name Windowing
  set block_cell_name Windowing_R
  if { [catch {set Windowing_R [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Windowing_R eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  connect_bd_net -net Audio_controller_R_Data_valid [get_bd_pins s_axis_r_tvalid] [get_bd_pins Packet_framer_R/s_axis_tvalid] [get_bd_pins Windowing_R/S_AXIS_DATA_tvalid]
  connect_bd_net -net BRAM_ADDR_SLICE_Dout [get_bd_pins BRAM_ADDR_SLICE/Dout] [get_bd_pins Windowing_L/addra] [get_bd_pins Windowing_R/addra]
  connect_bd_net -net BRAM_DIN_SLICE1_Dout [get_bd_pins BRAM_DIN_SLICE1/Dout] [get_bd_pins Windowing_L/dina] [get_bd_pins Windowing_R/dina]
  connect_bd_net -net BRAM_WE_SLICE2_Dout [get_bd_pins BRAM_WE_SLICE2/Dout] [get_bd_pins Windowing_L/wea] [get_bd_pins Windowing_R/wea]
  ...
  connect_bd_net -net FFT_L_data_y [get_bd_pins FFT_L/s_axis_data_tdata] [get_bd_pins FFT_L_data/y]
  connect_bd_net -net FFT_L_last_y [get_bd_pins FFT_L/s_axis_data_tlast] [get_bd_pins FFT_L_last/y]
  connect_bd_net -net FFT_L_s_axis_config_tready [get_bd_pins FFT_L/s_axis_config_tready] [get_bd_pins Ready_AND/Op1]
  connect_bd_net -net FFT_L_valid_y [get_bd_pins FFT_L/s_axis_data_tvalid] [get_bd_pins FFT_L_valid/y]
  connect_bd_net -net FFT_R_data_y [get_bd_pins FFT_R/s_axis_data_tdata] [get_bd_pins FFT_R_data/y]
  connect_bd_net -net FFT_R_last_y [get_bd_pins FFT_R/s_axis_data_tlast] [get_bd_pins FFT_R_last/y]
  connect_bd_net -net FFT_R_s_axis_config_tready [get_bd_pins FFT_R/s_axis_config_tready] [get_bd_pins Ready_AND/Op2]
  connect_bd_net -net FFT_R_valid_y [get_bd_pins FFT_R/s_axis_data_tvalid] [get_bd_pins FFT_R_valid/y]
  ...
  connect_bd_net -net Net [get_bd_pins FFT_L_data/sel] [get_bd_pins FFT_L_last/sel] [get_bd_pins FFT_L_valid/sel] [get_bd_pins FFT_R_data/sel] [get_bd_pins FFT_R_last/sel] [get_bd_pins FFT_R_valid/sel] [get_bd_pins FFT_WINDOW_en/gpio_io_o]
  ...
  connect_bd_net -net Packet_framer_L_m_axis_tdata [get_bd_pins FFT_L_data/a] [get_bd_pins Packet_framer_L/m_axis_tdata]
  connect_bd_net -net Packet_framer_L_m_axis_tlast [get_bd_pins FFT_L_last/a] [get_bd_pins Packet_framer_L/m_axis_tlast]
  connect_bd_net -net Packet_framer_L_m_axis_tvalid [get_bd_pins FFT_L_valid/a] [get_bd_pins Packet_framer_L/m_axis_tvalid]
  connect_bd_net -net Packet_framer_R_m_axis_tdata [get_bd_pins FFT_R_data/a] [get_bd_pins Packet_framer_R/m_axis_tdata]
  connect_bd_net -net Packet_framer_R_m_axis_tlast [get_bd_pins FFT_R_last/a] [get_bd_pins Packet_framer_R/m_axis_tlast]
  connect_bd_net -net Packet_framer_R_m_axis_tvalid [get_bd_pins FFT_R_valid/a] [get_bd_pins Packet_framer_R/m_axis_tvalid]
  connect_bd_net -net Ready_AND_Res [get_bd_pins FFT_CONFIG/m_axis_fftconfig_tready] [get_bd_pins Ready_AND/Res]
  connect_bd_net -net Windowing_L_M_AXIS_DATA_tdata [get_bd_pins FFT_L_data/b] [get_bd_pins Windowing_L/M_AXIS_DATA_tdata]
  connect_bd_net -net Windowing_L_M_AXIS_DATA_tlast [get_bd_pins FFT_L_last/b] [get_bd_pins Windowing_L/M_AXIS_DATA_tlast]
  connect_bd_net -net Windowing_L_M_AXIS_DATA_tvalid [get_bd_pins FFT_L_valid/b] [get_bd_pins Windowing_L/M_AXIS_DATA_tvalid]
  connect_bd_net -net Windowing_R_M_AXIS_DATA_tdata [get_bd_pins FFT_R_data/b] [get_bd_pins Windowing_R/M_AXIS_DATA_tdata]
  connect_bd_net -net Windowing_R_M_AXIS_DATA_tlast [get_bd_pins FFT_R_last/b] [get_bd_pins Windowing_R/M_AXIS_DATA_tlast]
  connect_bd_net -net Windowing_R_M_AXIS_DATA_tvalid [get_bd_pins FFT_R_valid/b] [get_bd_pins Windowing_R/M_AXIS_DATA_tvalid]
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_pins BRAM_ADDR_SLICE/Din] [get_bd_pins axi_bram_ctrl_0/bram_addr_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_clk_a [get_bd_pins Windowing_L/clka] [get_bd_pins Windowing_R/clka] [get_bd_pins axi_bram_ctrl_0/bram_clk_a]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins HDMI_FFT_LR/S_AXI_WND_BRAM] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
