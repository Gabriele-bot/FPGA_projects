...
HD_PWD='G:/Vivado/FFT_VIDEO/FFT_VIDEO_2048.xpr/FFT_VIDEO_2048/FFT_VIDEO_2048.runs/base_AXI_MUX_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_AXI_MUX_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_AXI_MUX_0_1.tcl
