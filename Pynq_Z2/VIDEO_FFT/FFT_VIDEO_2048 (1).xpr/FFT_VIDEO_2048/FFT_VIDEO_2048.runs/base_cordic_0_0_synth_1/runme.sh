...
HD_PWD='D:/Progetti_vivado/FFT_VIDEO/FFT_VIDEO.runs/base_cordic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_cordic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_cordic_0_0.tcl
