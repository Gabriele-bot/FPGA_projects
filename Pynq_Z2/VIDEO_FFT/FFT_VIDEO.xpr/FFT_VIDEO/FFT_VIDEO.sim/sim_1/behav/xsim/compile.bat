...
REM
REM Generated by Vivado on Wed Mar 17 01:12:30 +0100 2021
...
echo "xvhdl --incr --relax -prj Test_wrapper_tb_vhdl.prj"
call xvhdl  --incr --relax -prj Test_wrapper_tb_vhdl.prj -log xvhdl.log
