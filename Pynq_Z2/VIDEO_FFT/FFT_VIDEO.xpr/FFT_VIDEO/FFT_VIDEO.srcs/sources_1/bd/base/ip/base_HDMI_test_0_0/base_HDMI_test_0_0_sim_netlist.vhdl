...
--               d:/Progetti_vivado/FFT_VIDEO/FFT_VIDEO.srcs/sources_1/bd/base/ip/base_HDMI_test_0_0/base_HDMI_test_0_0_sim_netlist.vhdl
...
entity base_HDMI_test_0_0_HDMI_test is
  port (
    ...
    clk : in STD_LOGIC;
    data_r : in STD_LOGIC_VECTOR ( 9 downto 0 );
    data_l : in STD_LOGIC_VECTOR ( 9 downto 0 )
  );
...
architecture STRUCTURE of base_HDMI_test_0_0_HDMI_test is
  ...
  signal DrawArea_i_4_n_0 : STD_LOGIC;
  signal DrawArea_i_5_n_0 : STD_LOGIC;
  ...
  signal state_Next02_out : STD_LOGIC;
  signal state_Next2 : STD_LOGIC;
  signal state_Next20_in : STD_LOGIC;
  signal state_Next21_in : STD_LOGIC;
  signal state_Next22_in : STD_LOGIC;
  ...
  signal \state_Next2_inferred__1/i__carry__0_n_3\ : STD_LOGIC;
  signal \state_Next2_inferred__1/i__carry_n_0\ : STD_LOGIC;
  signal \state_Next2_inferred__1/i__carry_n_1\ : STD_LOGIC;
  signal \state_Next2_inferred__1/i__carry_n_2\ : STD_LOGIC;
  signal \state_Next2_inferred__1/i__carry_n_3\ : STD_LOGIC;
  signal \state_Next2_inferred__2/i__carry__0_n_3\ : STD_LOGIC;
  signal \state_Next2_inferred__2/i__carry_n_0\ : STD_LOGIC;
  signal \state_Next2_inferred__2/i__carry_n_1\ : STD_LOGIC;
  signal \state_Next2_inferred__2/i__carry_n_2\ : STD_LOGIC;
  signal \state_Next2_inferred__2/i__carry_n_3\ : STD_LOGIC;
  ...
  signal \NLW_state_Next2_inferred__1/i__carry_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_state_Next2_inferred__1/i__carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_state_Next2_inferred__1/i__carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_state_Next2_inferred__2/i__carry_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_state_Next2_inferred__2/i__carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_state_Next2_inferred__2/i__carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute BOX_TYPE : string;
  attribute BOX_TYPE of BUFG_CLKFB : label is "PRIMITIVE";
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \CounterX[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \CounterX[11]_i_3\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \CounterY[11]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of DrawArea_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of DrawArea_i_3 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of DrawArea_i_5 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \FSM_onehot_state_Curr[0]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \green[7]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of hSync_i_4 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of ren_i_1 : label is "soft_lutpair1";
  ...
  attribute COMPARATOR_THRESHOLD of \state_Next2_inferred__1/i__carry\ : label is 11;
  attribute COMPARATOR_THRESHOLD of \state_Next2_inferred__1/i__carry__0\ : label is 11;
  attribute COMPARATOR_THRESHOLD of \state_Next2_inferred__2/i__carry\ : label is 11;
  attribute COMPARATOR_THRESHOLD of \state_Next2_inferred__2/i__carry__0\ : label is 11;
  attribute SOFT_HLUTNM of vSync_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of vSync_i_3 : label is "soft_lutpair4";
begin
  PixelClk <= \^pixelclk\;
  vid_pVDE <= \^vid_pvde\;
...
\CounterX[11]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
...
\CounterY[11]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFBF"
    )
        port map (
...
\CounterY[11]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
DrawArea_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
DrawArea_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
DrawArea_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\FSM_onehot_state_Curr[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00FE"
    )
        port map (
...
\state_Next2_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(1) => state_Next21_in,
      CO(0) => \state_Next2_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \state_Next2_carry__0_i_1_n_0\,
      O(3 downto 0) => \NLW_state_Next2_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3 downto 2) => B"00",
      S(1) => \state_Next2_carry__0_i_2_n_0\,
      S(0) => \state_Next2_carry__0_i_3_n_0\
    );
...
\state_Next2_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\state_Next2_inferred__1/i__carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \state_Next2_inferred__1/i__carry_n_0\,
      CO(2) => \state_Next2_inferred__1/i__carry_n_1\,
      CO(1) => \state_Next2_inferred__1/i__carry_n_2\,
      CO(0) => \state_Next2_inferred__1/i__carry_n_3\,
      CYINIT => '0',
      DI(3) => \i__carry_i_1__0_n_0\,
      DI(2) => \i__carry_i_2__0_n_0\,
      DI(1) => \i__carry_i_3__0_n_0\,
      DI(0) => \i__carry_i_4__0_n_0\,
      O(3 downto 0) => \NLW_state_Next2_inferred__1/i__carry_O_UNCONNECTED\(3 downto 0),
      S(3) => \i__carry_i_5__0_n_0\,
      S(2) => \i__carry_i_6__0_n_0\,
      S(1) => \i__carry_i_7__0_n_0\,
      S(0) => \i__carry_i_8__0_n_0\
    );
\state_Next2_inferred__1/i__carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => \state_Next2_inferred__1/i__carry_n_0\,
      CO(3 downto 2) => \NLW_state_Next2_inferred__1/i__carry__0_CO_UNCONNECTED\(3 downto 2),
      CO(1) => state_Next2,
      CO(0) => \state_Next2_inferred__1/i__carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \i__carry__0_i_1_n_0\,
      O(3 downto 0) => \NLW_state_Next2_inferred__1/i__carry__0_O_UNCONNECTED\(3 downto 0),
      S(3 downto 2) => B"00",
      S(1) => \i__carry__0_i_2_n_0\,
      S(0) => \i__carry__0_i_3_n_0\
    );
\state_Next2_inferred__2/i__carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \state_Next2_inferred__2/i__carry_n_0\,
      CO(2) => \state_Next2_inferred__2/i__carry_n_1\,
      CO(1) => \state_Next2_inferred__2/i__carry_n_2\,
      CO(0) => \state_Next2_inferred__2/i__carry_n_3\,
      CYINIT => '0',
      DI(3) => \i__carry_i_1__1_n_0\,
      DI(2) => \i__carry_i_2__1_n_0\,
      DI(1) => \i__carry_i_3__1_n_0\,
      DI(0) => \i__carry_i_4__1_n_0\,
      O(3 downto 0) => \NLW_state_Next2_inferred__2/i__carry_O_UNCONNECTED\(3 downto 0),
      S(3) => \i__carry_i_5__1_n_0\,
      S(2) => \i__carry_i_6__1_n_0\,
      S(1) => \i__carry_i_7__1_n_0\,
      S(0) => \i__carry_i_8__1_n_0\
    );
\state_Next2_inferred__2/i__carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => \state_Next2_inferred__2/i__carry_n_0\,
      CO(3 downto 2) => \NLW_state_Next2_inferred__2/i__carry__0_CO_UNCONNECTED\(3 downto 2),
      CO(1) => state_Next20_in,
      CO(0) => \state_Next2_inferred__2/i__carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \i__carry__0_i_1__1_n_0\,
      O(3 downto 0) => \NLW_state_Next2_inferred__2/i__carry__0_O_UNCONNECTED\(3 downto 0),
      S(3 downto 2) => B"00",
...
inst: entity work.base_HDMI_test_0_0_HDMI_test
     port map (
      ...
      clk => clk,
      data_l(9 downto 0) => data_l(23 downto 14),
      data_r(9 downto 0) => data_r(23 downto 14),
      ren => ren,
