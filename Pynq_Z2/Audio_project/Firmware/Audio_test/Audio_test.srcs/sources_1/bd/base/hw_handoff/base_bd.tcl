...
proc create_hier_cell_Audio_controller { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins audio_codec_ctrl_0/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins s_axi_ctrl] [get_bd_intf_pins i2s_audio_stream/s_axi_ctrl]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins s_axi_ctrl1] [get_bd_intf_pins i2s_audio_stream/s_axi_ctrl1]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins S_AXI1] [get_bd_intf_pins mux_sel/S_AXI]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Audio_controller/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins Audio_controller/s_axi_ctrl] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins Audio_controller/s_axi_ctrl1] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins Audio_controller/S_AXI1] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  ...
  assign_bd_address -offset 0x41200000 -range 0x00002000 -target_address_space [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs switches_gpio/S_AXI/Reg] -force
